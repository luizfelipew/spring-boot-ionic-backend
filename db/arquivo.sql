...
INSERT INTO `categoria` VALUES (1,'Informática'),(2,'Escritório'),(3,'Cama mesa e banho'),(4,'Eletrônicos'),(5,'Jardinagem'),(6,'Decoracao'),(7,'Perfumaria');
...
CREATE TABLE `cliente` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cpf_ou_cnpj` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `endereco` VALUES (1,'Jardim','38220834','Apto 303','Rua Flores','300',1,1),(2,'Centro','38777012','Sala 80','Avenida Matos','105',2,1);
...
CREATE TABLE `telefone` (
  ...
  `telefones` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dump completed on 2020-04-30 17:53:35
